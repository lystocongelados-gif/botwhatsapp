...
mensaje en lenguaje natural, usando la API gratuita de Groq para
interpretarlo contra la lista de precios y la base de clientes.
...
- `GROQ_API_KEY` → tu API key gratuita de https://console.groq.com/keys
...
No hace falta tocar nada en Railway salvo que cambie `GROQ_API_KEY`.
